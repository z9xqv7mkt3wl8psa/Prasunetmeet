...
useEffect(() => {
  const handleOpenModal = (e: CustomEvent) => {
    const type = e.detail as MeetingState;
    setMeetingState(type);
  };

  window.addEventListener("openMeetingModal", handleOpenModal as EventListener);

  return () => {
    window.removeEventListener("openMeetingModal", handleOpenModal as EventListener);
  };
}, []);
